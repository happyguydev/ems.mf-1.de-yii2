...
$user_count = User::find()->where(['user_role' => 'user'])->count();

?>
   <!--   <div class="row" data-plugin="matchHeight" data-by-row="true">
      <div class="col-sm-3">
 Widget Linearea One
    <a href="<?=Yii::getAlias('@web');?>/admin/user" style="text-decoration:none">
      <div class="widget">
        <div class="widget-content padding-30 bg-orange-600">
          <div class="widget-watermark darker font-size-60 margin-15" style="opacity: 1; color:white;">
          <i class="icon fa-user" aria-hidden="true"></i></div>
          <div class="counter counter-md counter-inverse text-left">
            <div class="counter-number-group">
              <span class="counter-number"><?=$user_count?></span>
              <span class="counter-number-related text-capitalize"><?=Yii::t('app', '');?></span>
            </div>
            <div class="counter-label text-capitalize"><?=Yii::t('app', 'Users');?></div>
          </div>
        </div>
      </div>
    </a>
                    ...
                    <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-12 xl:col-span-8 mt-6">
                            ...
                            <div class="intro-y box p-5 mt-12 sm:mt-5">
                                ...
                                <div class="report-maps mt-5 bg-gray-200 rounded-md" data-center="-6.2425342, 106.8626478" data-sources="/<?=Yii::getAlias('@web')?>/themes/admin/dist/json/location.json"></div>
                            </div>
                        </div>
                        <!-- END: Official Store -->
                        ...
                        <div class="col-span-12 xl:col-span-4 mt-6">
                            ...
                            <div class="mt-5">
                                <div class="intro-y">
                                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                            <img alt="Midone Tailwind HTML Admin Template" src="<?=Yii::getAlias('@web')?>/themes/admin/dist/images/profile-14.jpg">
                                        </div>
                                ...
                                <div class="intro-y">
                                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                            <img alt="Midone Tailwind HTML Admin Template" src="<?=Yii::getAlias('@web')?>/themes/admin/dist/images/profile-10.jpg">
                                        </div>
                                        <div class="ml-4 mr-auto">
                                ...
                                <div class="intro-y">
                                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                            <img alt="Midone Tailwind HTML Admin Template" src="<?=Yii::getAlias('@web')?>/themes/admin/dist/images/profile-2.jpg">
                                        </div>
                                        <div class="ml-4 mr-auto">
                                    ...
                                    <tbody>
                                            ...
                                            <td class="w-40">
                                                <div class="flex">
                                                    <div class="w-10 h-10 image-fit zoom-in">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=Yii::getAlias('@web')?>/themes/admin/dist/images/preview-6.jpg" title="Uploaded at 16 May 2020">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=Yii::getAlias('@web')?>/themes/admin/dist/images/preview-5.jpg" title="Uploaded at 8 April 2021">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=Yii::getAlias('@web')?>/themes/admin/dist/images/preview-2.jpg" title="Uploaded at 12 October 2020">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="intro-x">
                                            <td class="w-40">
                                                <div class="flex">
                                                    <div class="w-10 h-10 image-fit zoom-in">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=Yii::getAlias('@web')?>/themes/admin/dist/images/preview-5.jpg" title="Uploaded at 15 July 2022">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=Yii::getAlias('@web')?>/themes/admin/dist/images/preview-11.jpg" title="Uploaded at 23 July 2022">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=Yii::getAlias('@web')?>/themes/admin/dist/images/preview-9.jpg" title="Uploaded at 18 June 2022">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="intro-x">
                                            <td class="w-40">
                                                <div class="flex">
                                                    <div class="w-10 h-10 image-fit zoom-in">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=Yii::getAlias('@web')?>/themes/admin/dist/images/preview-4.jpg" title="Uploaded at 9 July 2020">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=Yii::getAlias('@web')?>/themes/admin/dist/images/preview-11.jpg" title="Uploaded at 19 September 2022">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=Yii::getAlias('@web')?>/themes/admin/dist/images/preview-10.jpg" title="Uploaded at 16 November 2021">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="intro-x">
                                            <td class="w-40">
                                                <div class="flex">
                                                    <div class="w-10 h-10 image-fit zoom-in">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=Yii::getAlias('@web')?>/themes/admin/dist/images/preview-2.jpg" title="Uploaded at 12 February 2022">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=Yii::getAlias('@web')?>/themes/admin/dist/images/preview-4.jpg" title="Uploaded at 12 April 2021">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=Yii::getAlias('@web')?>/themes/admin/dist/images/preview-12.jpg" title="Uploaded at 1 April 2021">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                            ...
                            <div class="col-span-12 md:col-span-6 xl:col-span-4 xxl:col-span-12 mt-3 xxl:mt-8">
                                ...
                                <div class="mt-5">
                                    ...
                                    <div class="intro-x">
                                        <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                            <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                                <img alt="Midone Tailwind HTML Admin Template" src="<?=Yii::getAlias('@web')?>/themes/admin/dist/images/profile-3.jpg">
                                            </div>
                                            <div class="ml-4 mr-auto">
                                ...
                                <div class="report-timeline mt-5 relative">
                                    <div class="intro-x relative flex items-center mb-3">
                                        <div class="report-timeline__image">
                                            <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                                <img alt="Midone Tailwind HTML Admin Template" src="<?=Yii::getAlias('@web')?>/themes/admin/dist/images/profile-9.jpg">
                                            </div>
                                        </div>
                                            ...
                                            <div class="text-gray-600">
                                                ...
                                                <div class="flex mt-2">
                                                    <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Nikon Z6">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="rounded-md border border-white" src="<?=Yii::getAlias('@web')?>/themes/admin/dist/images/preview-4.jpg">
                                                    </div>
                                                    <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Sony A7 III">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="rounded-md border border-white" src="<?=Yii::getAlias('@web')?>/themes/admin/dist/images/preview-1.jpg">
                                                    </div>
                                    ...
                                    <div class="intro-x relative flex items-center mb-3">
                                        <div class="report-timeline__image">
                                            <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                                <img alt="Midone Tailwind HTML Admin Template" src="<?=Yii::getAlias('@web')?>/themes/admin/dist/images/profile-6.jpg">
                                            </div>
                                        </div>
                                        <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                            <div class="flex items-center">
                                    ...
                                    <div class="intro-x relative flex items-center mb-3">
                                        <div class="report-timeline__image">
                                            <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                                <img alt="Midone Tailwind HTML Admin Template" src="<?=Yii::getAlias('@web')?>/themes/admin/dist/images/profile-4.jpg">
                                            </div>
                                        </div>
                                        <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                            <div class="flex items-center">
